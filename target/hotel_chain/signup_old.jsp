        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav ml-auto">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="login.jsp" class="nav-link link">Log-in</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container form-outer-container">
        ...
        <form action="<%= request.getContextPath() %>/register" method="post" >
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="date" name="date_of_birth" placeholder="MM/DD/YYY" type="text"/>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="form-check">
                <div class="row">
                    <div class="col-8">
                        <input type="checkbox" class="form-check-input" id="сheck1">
                        <label class="form-check-label" for="check1">I agree with the <a class="terms-ud" href="#">Terms
